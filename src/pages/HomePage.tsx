  ...
  return (
    <div className="home-page">
      ...
      <DiagnosticsEntryBottomSheet
        open={isDiagnosticsSheetOpen}
        onClose={() => setIsDiagnosticsSheetOpen(false)}
        showHealthCheckups={showDiagSheetHealthCheckups}
        showLabTests={showDiagSheetLabTests}
        onHealthCheckups={() => {
