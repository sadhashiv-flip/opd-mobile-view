...
export type BorderGlowProps = Readonly<{
  children: ReactNode;
  className?: string;
  /** Pale cards: subtle rim; inset ring so borders aren’t covered by opaque children. */
  lightTheme?: boolean;
  /** Charcoal / gray cards — mesh and edge glow read clearly (like the original dark demo). */
  darkSurface?: boolean;
...
export default function BorderGlow({
  ...
  return (
    <div
      ...
      className={`border-glow-card ${lightTheme ? "border-glow-card--light" : ""} ${darkSurface ? "border-glow-card--dark-surface" : ""} ${className}`.trim()}
      style={style}
    >
